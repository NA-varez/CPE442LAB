...
pthread_barrier_t barrierSobel, barrierGrayScale, barrierContinue;
//				  barrierStart, barrierContinue, barrierEnd;
/************************************************************************/
...
int main(int argc, char** argv) {
    ...
    while (true) {
		...
		thread2Args.start = thread_rows + 1;
		...
		thread3Args.start = (thread_rows * 2) + 1;
		...
		thread4Args.start = (thread_rows * 3) + 1;
